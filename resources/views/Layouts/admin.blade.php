    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-menu a.active {
            ...
            border-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}: 4px solid white;
        }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('admin.cards') }}" class="{{ request()->routeIs('admin.cards') ? 'active' : '' }}">
                    <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="main-content">
        <!-- Top Bar -->
        <div class="top-bar">
            <h1>@yield('page-title', __('messages.admin_panel'))</h1>
