...
<head>
    ...
    <title><?php echo $__env->yieldContent('title',  __('messages.dashboard')); ?></title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .language-dropdown-content {
            display: none;
            position: absolute;
            <?php echo e(app()->getLocale() == 'ar' ? 'left' : 'right'); ?>: 0;
  ...
  <div id="globalPopupCard" class="popup-card" tabindex="-1">
    ...
    <nav class="navbar">
        <h2>
            ...
            <?php echo e(__('messages.Digital_Bank')); ?>
        ...
        <div class="nav-links">
            ...
            <div class="language-dropdown" id="languageDropdown">
                ...
                <div class="language-dropdown-content">
                    <a href="<?php echo e(route('language.switch', 'ar')); ?>" class="<?php echo e(app()->getLocale() == 'ar' ? 'active' : ''); ?>">
                         <?php echo e(__('messages.arabic')); ?>

                    </a>
                    <a href="<?php echo e(route('language.switch', 'en')); ?>" class="<?php echo e(app()->getLocale() == 'en' ? 'active' : ''); ?>">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_admin_dashboard')): ?>
                ...
                <a href="<?php echo e(route('cards.index')); ?>">
                    ...
                    <?php echo e(__('messages.my_cards')); ?>
...
(function(){
  ...
  try {
    popupType = <?php echo session('success') ? "'success'" : (session('error') || $errors->any() ? "'error'" : "null"); ?>;
    popupMsg = <?php echo json_encode(session('success') ?? session('error') ?? ($errors->first() ?? null), JSON_UNESCAPED_UNICODE); ?>;
  } catch(e){}
...
<?php /**PATH C:\xampp\htdocs\bank-graduation-project-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>